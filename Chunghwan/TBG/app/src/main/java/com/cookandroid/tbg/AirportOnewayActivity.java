...
public class AirportOnewayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        airport_go_betweenBtn = findViewById(R.id.airport_go_betweenBtn);
        airport_go_betweenBtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        selectedDate=findViewById(R.id.airport_oneway_calendar);
        calendarButton = findViewById(R.id.airport_oneway_calendar);
