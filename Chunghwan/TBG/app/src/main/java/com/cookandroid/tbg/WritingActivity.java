...
public class WritingActivity extends AppCompatActivity {
    ...
    private static final String CREATE_POST_URL = "http://10.0.2.2:8888/kch_server/CreatePost";
    private static final String UPDATE_POST_URL = "http://10.0.2.2:8888/kch_server/UpdatePost";
