...
public class TrainOnewayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        train_go_betweenBtn = findViewById(R.id.train_go_betweenBtn);
        train_go_betweenBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        selectedDate=findViewById(R.id.train_oneway_calendar);
        calendarButton = findViewById(R.id.train_oneway_calendar);
