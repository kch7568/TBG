...
public class BusBetweenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedDate2=findViewById(R.id.bus_between_Arrivecalendar);
        calendarButton2 = findViewById(R.id.bus_between_Arrivecalendar);
        MaterialDatePicker materialDatePicker2 = MaterialDatePicker.Builder.datePicker().setTitleText("Select Arrival Date").setSelection(MaterialDatePicker.todayInUtcMilliseconds()).build();
